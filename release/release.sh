...
"$earthly" --push --build-arg DOCKERHUB_USER --build-arg DOCKERHUB_IMG --build-arg DOCKERHUB_BUILDKIT_IMG --build-arg RELEASE_TAG --build-arg PUSH_LATEST_TAG +release-dockerhub --PUSH_PRERELEASE_TAG="$PRERELEASE"
